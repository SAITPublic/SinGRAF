...
def volume_render_radiance_field(
    ...
    elif alpha_activation == 'sigmoid_learned':
        # added to apply sigmoid with global learnable parameter alpha
        sigma_a = torch.sigmoid(-occupancy/density_bias)/density_bias
